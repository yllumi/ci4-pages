...
<div class="row">
	<div class="col-md-6">
		<div class="card">
			<div class="card-body">
				<form action="<?php echo ($form_type == 'new' ? site_url('admin/post/tags/insert') : site_url('admin/post/tags/update')); ?>" method="post">
					<input type="hidden" name="id" value="<?php echo (isset($result->term_id) ? $result->term_id : ''); ?>" />
					<input type="hidden" name="post_type" value="<?php echo $post_type ?? 'post'; ?>" />
