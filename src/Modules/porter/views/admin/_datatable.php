		...
		<?php else: ?>
			...
			<?php foreach ($results as $result): ?>
				<tr>
					...
					<td class="text-end">
						<button class="btn btn-default btn-sm text-dark" title="Shortcode" data-toggle="popover" data-placement="bottom" data-content='{variable.get name="<?= $result['variable']; ?>"}'>
							<span class="fa fa-code"></span>
						</button>
						<div class="btn-group">
							<a class="btn btn-sm btn-success" href="<?php echo site_url('admin/variable/edit/'. $result['id']); ?>" title="Edit"><span class="fa fa-pencil"></span></a> 
							<a class="btn btn-sm btn-danger" onclick="return confirm('are you sure?')" href="<?php echo site_url('admin/variable/delete/' . $result['id']); ?>" title="Delete"><span class="fa fa-remove"></span></a>
						</div>
					</td>
				</tr>
			<?php endforeach; ?>
